<header class="font-jet">
    <nav class="bg-zinc-900 p-2.5 flex justify-center border-b-4 border-purple-700">
        <div class="flex items-center w-10/12 text-slate-100">
            <div class="w-2/12 flex items-center">
                <a class="opacity-75 w-8/12 m-auto hover:opacity-100" href="">
            ...
            <a href="https://github.com/Jelle-Kuipers"><i class="fa-brands fa-github opacity-75 mr-1 p-2 rounded-md hover:opacity-100 hover:bg-zinc-700"></i></a> 
                <a href="https://www.linkedin.com/in/jelle-kuipers-069ba11b6/"><i class="fa-brands fa-linkedin opacity-75 mr-1 p-2 rounded-md hover:opacity-100 hover:bg-zinc-700"></i></a>
            </div>
        </div>
    </nav>
</header>